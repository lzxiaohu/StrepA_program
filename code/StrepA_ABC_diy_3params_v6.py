# file name: StrepA_ABC_diy_3params_v6.py
...
np.savetxt("experimental_data/R0_samps_3params_3stars_v6_ud3.csv", R0_samps, delimiter=",")
np.savetxt("experimental_data/sigma_samps_3params_3stars_v6_ud3.csv", sigma_samps, delimiter=",")
np.savetxt("experimental_data/Dimmunity_samps_3params_3stars_v6_ud3.csv", Dimmunity_samps, delimiter=",")
np.savetxt("experimental_data/dists_acc_3params_3stars_v6_ud3.csv", dists_acc, delimiter=",")
np.savetxt("experimental_data/ss_3params_3stars_v6_ud3.csv", ss, delimiter=",")
