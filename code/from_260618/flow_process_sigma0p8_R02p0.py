# file name: flow_process_sigma0p8_R02p0.py
...
def plot_posetrior_concentration(
    file_dists='../../experimental_data/from_260618/dists_sigma0p8_R02p0_seed1690_recal.csv',
    file_R0='../../experimental_data/from_260618/R0.csv',
    file_sigma='../../experimental_data/from_260618/sigma.csv',
    percentile=1.0,
    ...
    bw_method='silverman',
    title="ABC Posterior",
    save_path='../../figures/from_260618/ppc/sigma0p8/R02p0_seed1690/',
...
def plot_r0_sigma(true_R0, true_sigma, peak_R0s, peak_sigmas,
                   ...
                   save_path='../../figures/from_260618/ppc/sigma0p8/R02p0/', 
...
if __name__ == "__main__":
    ...
    file_dists='../../experimental_data/from_260618/dists_sigma0p8_R02p0'
    # file_dists='../../experimental_data/from_260618/dists_sigma0p8_R02p0_seed1690_recal'
    ...
    for seed_sn in seed_number: 
        ...
        # Step 6: Save results
        output_file = f'../../experimental_data/from_260618/optimal_weights_results_sigma0p8_R02p0_seed{seed_sn}.csv'
        ...
        result = analyze_distances(
            ...
            metric="euclidean",
            p=3,
            output_path=f"../../experimental_data/from_260618/dists_sigma0p8_R02p0_seed{seed_sn}_recal.csv"
        )
