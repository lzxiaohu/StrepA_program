...
# CONFIG
# ----------------------------------------------------------------------
input_dir = "../../experimental_data/from_260618/"  # directory containing peak_estimates_*.csv files
file_pattern = "peak_estimates_*.csv"
output_csv = "../../experimental_data/from_260618/identifiability_summary.csv"
output_tex = "../../experimental_data/from_260618/table_s1_identifiability.tex"
output_compact_csv = "../../experimental_data/from_260618/identifiability_summary_compact.csv"
output_compact_tex = "../../experimental_data/from_260618/table_identifiability_compact.tex"
