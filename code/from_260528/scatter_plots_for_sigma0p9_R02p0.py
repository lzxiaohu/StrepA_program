# file name: scatter_plots_for_sigma0p9_R02p0.py
...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.10626912, 0.1240123, 0.38240032, 0.17352608),  # Fixed: added commas
        weights=(0.3, 0.9, 0.1, 0.6),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260528/dists_sigma0p9_R02p0_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    # plot_dots_multiple_percentiles(
    #     file_dists='../../experimental_data/from_260528/dists_sigma0p9_R02p0_recal.csv',
    ...
    #     save_path="../../figures/from_260528/ppc/sigma0p9/R02p0/",
    #     xlim=(1, 8),      # R0 range
