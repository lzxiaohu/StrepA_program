# file name: scatter_plots_for_sigma0p8_R01p3_seed1234.py
...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.01567278, 0.02939822, 0.6748758, 0.05562015),  # Fixed: added commas
        weights=(0.9, 0.9, 0.1, 0.1),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260528/dists_sigma0p8_R01p3_seed1234_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    # plot_dots_multiple_percentiles(
    #     file_dists='../../experimental_data/from_260528/dists_sigma0p8_R01p3_seed1234_recal.csv',
    ...
    #     save_path="../../figures/from_260528/ppc/sigma0p8/R01p3_seed1234/",
    #     xlim=(1, 8),      # R0 range
