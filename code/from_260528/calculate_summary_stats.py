...
def calculate_summary_stats_clean(
    input_dir='../../experimental_data/from_260528/simulation_banks',
    output_file='../../experimental_data/from_260528/all_summary_statistics_clean.h5',
    mapping_file='../../experimental_data/from_260528/valid_indices.csv',
    n_jobs=40
):
    """
