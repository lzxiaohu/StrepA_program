# calculate_posterior_concentration_observations.py
...
if __name__ == "__main__":
    ...
    print(f"\n✅ posterior concentration (posterior): {ed:.6f}")
    
    # Plot scatter + contour
    for bw in ['silverman', 'scott', 0.5, 0.3, 0.2, 0.1]:
        ...
        peak_R0, peak_sigma = plot_posetrior_concentration(
            ...
            title="ABC Posterior",
            save_path='../../figures/from_260528/ppc/observations/',
            save_filename=f'posterior_scatter_contour_1percentile_{bw}.png'
        )
    ...
    for bw in ['silverman', 'scott', 0.5, 0.3, 0.2, 0.1]:
        ...
        peak_R0, peak_sigma = plot_posetrior_concentration(
            ...
            title="ABC Posterior",
            save_path='../../figures/from_260528/ppc/observations/',
            save_filename=f'posterior_scatter_contour_0p1percentile_{bw}.png'
        )
    ...
    for bw in ['silverman', 'scott', 0.5, 0.3, 0.2, 0.1]:
        ...
        peak_R0, peak_sigma = plot_posetrior_concentration(
            ...
            title="ABC Posterior",
            save_path='../../figures/from_260528/ppc/observations/',
            save_filename=f'posterior_scatter_contour_0p01percentile_{bw}.png'
        )
