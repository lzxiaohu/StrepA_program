# file name: scatter_plots_for_sigma0p8_R01p3_seed1212.py
...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.0206422, 0.04577786, 0.618183, 0.06102071),  # Fixed: added commas
        weights=(0.9, 0.5, 0.1, 0.1),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260528/dists_sigma0p8_R01p3_seed1212_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    # plot_dots_multiple_percentiles(
    #     file_dists='../../experimental_data/from_260528/dists_sigma0p8_R01p3_seed1212_recal.csv',
    ...
    #     save_path="../../figures/from_260528/ppc/sigma0p8/R01p3_seed1212/",
    #     xlim=(1, 8),      # R0 range
    ...
    plot_histograms_with_kde(
        ...
        true_R0=1.3,
        true_sigma=0.8,
        title="ABC Posterior - R0=1.3, sigma=0.8",
        save_path="../../figures/from_260528/ppc/sigma0p8/R01p3_seed1212/",
        R0_range=(1, 4),
        sigma_range=(0.2, 1.0),
        bins=50
    ...
    plot_histograms_multiple_percentiles(
        ...
        true_R0=1.3,
        true_sigma=0.8,
        title="ABC Posterior Evolution - R0=1.3, sigma=0.8",
        save_path="../../figures/from_260528/ppc/sigma0p8/R01p3_seed1212/",
        R0_range=(1, 4),
        sigma_range=(0.2, 1.0),
        bins=30
