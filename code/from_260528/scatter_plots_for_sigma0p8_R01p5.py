# file name: scatter_plots_for_sigma0p8_R01p5.py
...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.03937309, 0.08026515, 0.45865459, 0.0707455),  # Fixed: added commas
        weights=(0.9, 0.9, 0.1, 0.1),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260528/dists_sigma0p8_R01p5_recal.csv"
    )
