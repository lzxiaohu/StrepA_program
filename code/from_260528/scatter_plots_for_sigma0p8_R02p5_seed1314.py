# file name: scatter_plots_for_sigma0p8_R02p5_seed1314.py
...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.21330276, 0.3393805,  0.37759333, 0.1663435),  # Fixed: added commas
        weights=(0.6, 0.1, 0.1, 0.9),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260528/dists_sigma0p8_R02p5_seed1314_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    # plot_dots_multiple_percentiles(
    #     file_dists='../../experimental_data/from_260528/dists_sigma0p8_R02p5_seed1314_recal.csv',
    ...
    #     save_path="../../figures/from_260528/ppc/sigma0p8/R02p5_seed1314/",
    #     xlim=(1, 8),      # R0 range
