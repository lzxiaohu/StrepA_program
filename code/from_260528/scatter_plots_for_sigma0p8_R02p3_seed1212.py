# file name: scatter_plots_for_sigma0p8_R02p3_seed1212.py
...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.09785933, 0.1965388, 0.28768515, 0.15908387),  # Fixed: added commas
        weights=(0.4, 0.9, 0.1, 0.1),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260528/dists_sigma0p8_R02p3_seed1212_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    # plot_dots_multiple_percentiles(
    #     file_dists='../../experimental_data/from_260528/dists_sigma0p8_R02p3_seed1212_recal.csv',
    ...
    #     save_path="../../figures/from_260528/ppc/sigma0p8/R02p3_seed1212/",
    #     xlim=(1, 8),      # R0 range
