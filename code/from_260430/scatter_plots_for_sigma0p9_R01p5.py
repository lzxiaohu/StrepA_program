...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.00982922, 0.01093009, 0.25759117, 0.09377478),  # Fixed: added commas
        weights=(0.9, 0.9, 0.1, 0.4),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260430/dists_sigma0p9_R01p5_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    # plot_dots_multiple_percentiles(
    #     file_dists='../../experimental_data/from_260430/dists_sigma0p9_R01p5_recal.csv',
    ...
    #     save_path="../../figures/from_260430/ppc/sigma0p9/R01p5/",
    #     xlim=(1, 8),      # R0 range
    ...
    plot_histograms_with_kde(
        ...
        true_R0=1.5,
        true_sigma=0.9,
        title="ABC Posterior - R0=1.5, sigma=0.5",
        save_path="../../figures/from_260430/ppc/sigma0p9/R01p5/",
        R0_range=(1, 8),
        sigma_range=(0.2, 1.0),
        bins=50
