...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.5008094, 0.49177995, 0.37434107, 0.54462704),  # Fixed: added commas
        weights=(0.1, 0.1, 0.9, 0.9),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260430/dists_sigma0p5_R04p5_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    plot_dots_multiple_percentiles(
        file_dists='../../experimental_data/from_260430/dists_sigma0p5_R04p5_recal.csv',
        ...
        save_path="../../figures/from_260430/ppc/sigma0p5/R04p5/",
        xlim=(1, 8),      # R0 range
