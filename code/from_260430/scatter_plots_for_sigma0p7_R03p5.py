...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.21267969, 0.25045505, 0.16401393, 0.25496983),  # Fixed: added commas
        weights=(0.3, 0.1, 0.7, 0.1),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260430/dists_sigma0p7_R03p5_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    # plot_dots_multiple_percentiles(
    #     file_dists='../../experimental_data/from_260430/dists_sigma0p7_R03p5_recal.csv',
    ...
    #     save_path="../../figures/from_260430/ppc/sigma0p7/R03p5/",
    #     xlim=(1, 8),      # R0 range
    ...
    plot_histograms_with_kde(
        ...
        true_R0=3.5,
        true_sigma=0.7,
        title="ABC Posterior - R0=3.5, sigma=0.7",
        save_path="../../figures/from_260430/ppc/sigma0p7/R03p5/",
        R0_range=(1, 8),
        sigma_range=(0.2, 1.0),
        bins=50
    ...
    plot_histograms_multiple_percentiles(
        ...
        true_R0=3.5,
        true_sigma=0.7,
        title="ABC Posterior Evolution - R0=3.5, sigma=0.7",
        save_path="../../figures/from_260430/ppc/sigma0p7/R03p5/",
        R0_range=(1, 8),
        sigma_range=(0.2, 1.0),
        bins=30
