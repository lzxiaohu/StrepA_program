...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.31826674, 0.32391104, 0.31341846, 0.53757094),  # Fixed: added commas
        weights=(0.8, 0.9, 0.9, 0.1),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260430/dists_sigma0p6_R03p5_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    plot_dots_multiple_percentiles(
        file_dists='../../experimental_data/from_260430/dists_sigma0p6_R03p5_recal.csv',
        ...
        save_path="../../figures/from_260430/ppc/sigma0p6/R03p5/",
        xlim=(1, 8),      # R0 range
