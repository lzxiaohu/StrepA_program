...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.06302986, 0.10695967, 0.15458852, 0.17575635),  # Fixed: added commas
        weights=(0.1, 0.9, 0.1, 0.1),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260430/dists_sigma0p8_R02p5_recal.csv"
    )
    
    # 2. Plot with higher percentiles (10%, 5%, 4%, 3%, 2%, 1%)
    # plot_dots_multiple_percentiles(
    #     file_dists='../../experimental_data/from_260430/dists_sigma0p8_R02p5_recal.csv',
