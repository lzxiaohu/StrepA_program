...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.36146947, 0.34413194, 0.28825689, 0.57782497),  # Fixed: added commas
        weights=(0.1, 0.1, 0.4, 0.9),  # Fixed: added commas
        metric="euclidean",
        p=3,
    ...
    plot_histograms_with_kde(
        ...
        true_R0=5.0,
        true_sigma=0.7,
        title="ABC Posterior - R0=5.0, sigma=0.7",
        save_path="../../figures/from_260430/ppc/sigma0p7/R05p0/",
        R0_range=(1, 8),
        sigma_range=(0.2, 1.0),
        bins=50
    ...
    plot_histograms_multiple_percentiles(
        ...
        true_R0=5.0,
        true_sigma=0.7,
        title="ABC Posterior Evolution - R0=5.0, sigma=0.7",
        save_path="../../figures/from_260430/ppc/sigma0p7/R05p0/",
        R0_range=(1, 8),
        sigma_range=(0.2, 1.0),
        bins=30
