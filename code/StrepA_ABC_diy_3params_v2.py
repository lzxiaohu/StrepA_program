# file name: StrepA_ABC_diy_3params_v2.py
...
scale = np.array([20.0, 220.0, 12000, 18, 60, 0.8, 20], dtype=float)
print("scale", scale)
...
np.savetxt("experimental_data/R0_samps_3params_3stars_v2_ud3.csv", R0_samps, delimiter=",")
np.savetxt("experimental_data/sigma_samps_3params_3stars_v2_ud3.csv", sigma_samps, delimiter=",")
np.savetxt("experimental_data/Dimmunity_samps_3params_3stars_v2_ud3.csv", Dimmunity_samps, delimiter=",")
np.savetxt("experimental_data/dists_acc_3params_3stars_v2_ud3.csv", dists_acc, delimiter=",")
np.savetxt("experimental_data/ss_3params_3stars_v2_ud3.csv", ss, delimiter=",")
