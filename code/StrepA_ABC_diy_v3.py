...
def summary_stats(series_2d):
    ...
    return np.array(
        [avg_time_obs, max_time_obs, num_strains_obs], float)
...
np.savetxt("./experimental_data/R0_samps_v03.csv", R0_samps, delimiter=",")
np.savetxt("./experimental_data/sigma_samps_v03.csv", sigma_samps, delimiter=",")
np.savetxt("./experimental_data/dists_acc_v03.csv", dists_acc, delimiter=",")
