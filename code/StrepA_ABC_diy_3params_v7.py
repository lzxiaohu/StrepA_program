# file name: StrepA_ABC_diy_3params_v7.py
...
def summary_stats(series_2d):
    ...
    return np.array(
        [avg_time_obs, num_strains_obs, avg_div_obs, avg_npmi_obs, div_all_isolates_obs], float)
...
scale = np.array([22.0, 20.0, 18, 0.8, 20], dtype=float)
print("scale", scale)
...
np.savetxt("experimental_data/R0_samps_3params_3stars_v7_ud3.csv", R0_samps, delimiter=",")
np.savetxt("experimental_data/sigma_samps_3params_3stars_v7_ud3.csv", sigma_samps, delimiter=",")
np.savetxt("experimental_data/Dimmunity_samps_3params_3stars_v7_ud3.csv", Dimmunity_samps, delimiter=",")
np.savetxt("experimental_data/dists_acc_3params_3stars_v7_ud3.csv", dists_acc, delimiter=",")
np.savetxt("experimental_data/ss_3params_3stars_v7_ud3.csv", ss, delimiter=",")
