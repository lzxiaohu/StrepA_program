...
def summary_stats(series_2d):
    ...
    return np.array(
        [avg_time_obs, num_strains_obs, avg_div_obs,
...
scale = np.array([21.0, 19.0, 17, 45, 0.6, 17], dtype=float)
print("scale", scale)
...
np.savetxt("experimental_data/R0_samps_3params_3stars_v8_ud3.csv", R0_samps, delimiter=",")
np.savetxt("experimental_data/sigma_samps_3params_3stars_v8_ud3.csv", sigma_samps, delimiter=",")
np.savetxt("experimental_data/Dimmunity_samps_3params_3stars_v8_ud3.csv", Dimmunity_samps, delimiter=",")
np.savetxt("experimental_data/dists_acc_3params_3stars_v8_ud3.csv", dists_acc, delimiter=",")
np.savetxt("experimental_data/ss_3params_3stars_v8_ud3.csv", ss, delimiter=",")
