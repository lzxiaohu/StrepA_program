# file name: StrepA_ABC_diy_3stars.py
...
def summary_stats(series_2d):
    ...
    return np.array(
        [avg_time_obs, avg_prev_obs, var_prev_obs, avg_div_obs, avg_npmi_obs], float)
...
scale = np.array([23.0, 150.0, 2000.0, 20.0, 1.0], dtype=float)
print("scale", scale)
...
np.savetxt("experimental_data/R0_samps_3stars_v1.csv", R0_samps, delimiter=",")
np.savetxt("experimental_data/sigma_samps_3stars_v1.csv", sigma_samps, delimiter=",")
np.savetxt("experimental_data/dists_acc_3stars_v1.csv", dists_acc, delimiter=",")
