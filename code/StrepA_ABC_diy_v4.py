...
def summary_stats(series_2d):
    ...
    return np.array(
        [avg_time_obs, max_time_obs, num_strains_obs, avg_time_repeat_obs], float)
...
np.savetxt("./experimental_data/R0_samps_v04.csv", R0_samps, delimiter=",")
np.savetxt("./experimental_data/sigma_samps_v04.csv", sigma_samps, delimiter=",")
np.savetxt("./experimental_data/dists_acc_v04.csv", dists_acc, delimiter=",")
