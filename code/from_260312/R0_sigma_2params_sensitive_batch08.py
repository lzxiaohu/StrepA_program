...
# output
out_dir = "../../experimental_data/from_260312"
...
MASTER_SEED = 1432871125  # controls reproducibility of the entire experiment
...
if core_params_num == 2:
    ...
    out_path = os.path.join(out_dir, "R0_sigma_sensitive_2params_batch08.csv")
else:
