...
# synthetic data
if core_params_num == 2:
    _Tdry = simulate_prevalence_v5_numba(np.array([3.0, 0.7], float), fixed_params, core_params_num, seed=int(123))
    T = _Tdry.size
    logging.info(f"T's size: {T}")
    # print("T's size", T)
    _Tdry1 = simulate_prevalence_v5_numba(np.array([3.0, 0.7], float), fixed_params, core_params_num, seed=int(123))
    ...
    _Tdry = simulate_prevalence_v5_numba(np.array([3.0, 0.7, 0.25 * 52.14], float), fixed_params, core_params_num,
                                         seed=int(123))
    T = _Tdry.size
    logging.info(f"T's size: {T}")
    # print("T's size", T)
    _Tdry1 = simulate_prevalence_v5_numba(np.array([3.0, 0.7, 0.25 * 52.14], float), fixed_params, core_params_num,
                                          seed=int(123))
    logging.info(f"allclose={np.allclose(_Tdry, _Tdry1)}, same_shape={_Tdry.shape == _Tdry1.shape}")
    # print(np.allclose(_Tdry, _Tdry1), _Tdry.shape == _Tdry1.shape)
...
if core_params_num == 2:
    ...
    np.savetxt("../../experimental_data/from_260312/R0_samps_2params_R03p0.csv", R0_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260312/sigma_samps_2params_R03p0.csv", sigma_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260312/dists_acc_2params_R03p0.csv", dists_acc, delimiter=",")
    np.savetxt("../../experimental_data/from_260312/ss_2params_R03p0.csv", ss, delimiter=",")
    ...
    np.savetxt("../../experimental_data/from_260312/R0_samps_3params_R03p0.csv", R0_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260312/sigma_samps_3params_R03p0.csv", sigma_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260312/Dimmunity_samps_3params_R03p0.csv", Dimmunity_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260312/dists_acc_3params_R03p0.csv", dists_acc, delimiter=",")
    np.savetxt("../../experimental_data/from_260312/ss_3params_R03p0.csv", ss, delimiter=",")
else:
    raise ValueError('Invalid core params num')
