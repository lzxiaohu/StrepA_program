...
np.savetxt("./experimental_data/R0_samps.csv", R0_samps, delimiter=",")
np.savetxt("./experimental_data/sigma_samps.csv", sigma_samps, delimiter=",")
np.savetxt("./experimental_data/dists_acc.csv", dists_acc, delimiter=",")
