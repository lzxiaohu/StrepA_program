...
def summary_stats(series_2d):
    ...
    return np.array(
        [avg_time_obs, max_time_obs, num_strains_obs, avg_time_repeat_obs, var_time_repeat_obs, avg_prev_obs,
         var_prev_obs, avg_div_obs, var_div_obs], float)
...
np.savetxt("./experimental_data/R0_samps_v09.csv", R0_samps, delimiter=",")
np.savetxt("./experimental_data/sigma_samps_v09.csv", sigma_samps, delimiter=",")
np.savetxt("./experimental_data/dists_acc_v09.csv", dists_acc, delimiter=",")
