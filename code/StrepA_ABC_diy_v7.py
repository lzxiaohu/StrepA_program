...
np.savetxt("./experimental_data/R0_samps_v07.csv", R0_samps, delimiter=",")
np.savetxt("./experimental_data/sigma_samps_v07.csv", sigma_samps, delimiter=",")
np.savetxt("./experimental_data/dists_acc_v07.csv", dists_acc, delimiter=",")
