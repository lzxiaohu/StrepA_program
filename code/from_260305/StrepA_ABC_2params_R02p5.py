...
if core_params_num == 2:
    ...
    np.savetxt("../../experimental_data/from_260305/R0_samps_2params_R02p5.csv", R0_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260305/sigma_samps_2params_R02p5.csv", sigma_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260305/dists_acc_2params_R02p5.csv", dists_acc, delimiter=",")
    np.savetxt("../../experimental_data/from_260305/ss_2params_R02p5.csv", ss, delimiter=",")
    ...
    np.savetxt("../../experimental_data/from_260305/R0_samps_3params_R02p5.csv", R0_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260305/sigma_samps_3params_R02p5.csv", sigma_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260305/Dimmunity_samps_3params_R02p5.csv", Dimmunity_samps, delimiter=",")
    np.savetxt("../../experimental_data/from_260305/dists_acc_3params_R02p5.csv", dists_acc, delimiter=",")
    np.savetxt("../../experimental_data/from_260305/ss_3params_R02p5.csv", ss, delimiter=",")
else:
    raise ValueError('Invalid core params num')
